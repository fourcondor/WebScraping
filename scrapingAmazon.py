...
cookie_value = 'LPAZe1kNRLuVDxtZxtBZGxDp3D02Q9VDbKPkVsZ3Cu+gHOuI8b7EvDI+' \
               'ftUbgCz7Y1P4BgEmfjfKqxK+Tv3I1fFGfbqyPm/4q3ClOhQHS8bCU11ns' \
               '/F4xnfV4xwG+9uj8W6vhITxus7OLb7RUfdsZFTIcYKLDe9AhSYyHPXl41' \
               'za49dyqct9Edl3az9vF921IAcSoEi7iRjE02kK/eZeuJr92Hw5zkPwgXzQwCGYpA4='
        ...
        for link_i in links:
            ...
            try:
                prezzo_prodotto = new_soup.find("span",
                                                attrs={"class": "a-price a-text-price a-size-medium apexPriceToPay"}). \
                    find("span", attrs={"class": "a-offscreen"}).text.strip()
            except AttributeError as ae:
